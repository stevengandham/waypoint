...
const content = {
  ...
  about: {
    ...
    stats: [
      ...
      { label: "Where", value: "Beachpoint Church" },
  ...
  contact: {
    ...
    frequency: "Monthly",
    location: "Beachpoint Church",
    email: "waypoint@beachpoint.church",
    mapLink: "https://maps.google.com/?q=Beachpoint+Church",
  },
  ...
  socials: {
    ...
    items: [
      ...
      },
      {
        platform: "GroupMe",
        icon: "💬",
        handle: "Waypoint Chat",
        url: "#",
        label: "Join the chat",
      },
      {
        platform: "Beachpoint Church",
        icon: "⛪",
        handle: "beachpoint.church",
        url: "#",
        label: "Visit",
      },
    ],
